# Generated by Django 3.2.7 on 2022-10-19 10:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_price_type', models.CharField(choices=[('per_person', 'Per Person'), ('per_day', 'Per Day'), ('per_event', 'Per Event')], default='per_day', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_type', models.CharField(choices=[('discount_on_total_bill', 'Discount On Total Bill'), ('advance_and_discount_confirmation', 'Advance And Discount Confirmation'), ('discount_on_equipment_or_item', 'Discount On Equipment Or Item')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('places', 'Have You Place'), ('personal_skills', 'Personal Skills Bussiness'), ('group_skills', 'Group Skills Bussiness')], default='places', max_length=50)),
                ('display_name', models.CharField(max_length=50)),
                ('live', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('timestampe', models.DateTimeField(auto_now_add=True)),
                ('categoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category', to='userApi.eventcategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('IncludingFacilities', models.CharField(choices=[('romantic_stay', 'Romantic Stay'), ('romantic_candlelight_dinner', 'Romantic Candlelight Dinner'), ('romantic_lunch_dinner', 'Romantic Lunch/Dinner')], default='romantic_stay', max_length=100)),
                ...
                ('is_active', models.BooleanField(default=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='place_event', to='userApi.eventtype')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eventId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='EventWishlist', to='userApi.eventtype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='video', to='userApi.eventtype')),
            ],
        ),
        migrations.CreateModel(
            name='Transactions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eventId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='EventTickets', to='userApi.eventtype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('equipment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userApi.add_service_ev')),
                ('orgdiscount_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userApi.orgdiscounts')),
            ],
        ),
        migrations.CreateModel(
            name='O_Rats',
            fields=[
                ...
                ('User', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('eventId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='EventRating', to='userApi.eventtype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='image', to='userApi.eventtype')),
            ],
        ),
        migrations.CreateModel(
            name='ForWho',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill_banner', models.FileField(blank=True, null=True, upload_to='personal_details/banner/')),
                ('price_type', models.CharField(choices=[('per_day', 'PER DAY'), ('per_event', 'PER EVENT'), ('per_hour', 'PER HOUR')], default=0, max_length=255)),
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('eventId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='personal_details', to='userApi.eventtype')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(blank=True, null=True, upload_to='image/events/company')),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            ...
            name='eventId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_details', to='userApi.eventtype'),
        ),
        migrations.AddField(
            model_name='eventcompanydetails',
            name='user_id',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('timestampe', models.DateTimeField(auto_now_add=True)),
                ('discountId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discount_id', to='userApi.orgdiscounts')),
                ...
                ('serivceId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_id', to='userApi.add_service_ev')),
            ],
        ),
        migrations.CreateModel(
            name='Checkouts',
            fields=[
                ...
                ('eventId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='EventCheckout', to='userApi.eventtype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('0', 'HOME PAGE'), ('1', 'EVENT LISTING PAGE'), ('2', 'EVENT VIEW PAGE')], default=0, max_length=255)),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('timestampe', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event', to='userApi.eventtype')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
